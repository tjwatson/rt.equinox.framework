...
public class NamespaceListTest extends AbstractTest {
	...
	public void testGetList() throws Exception {
		...
		namespaceList = newNamespace(elements);
		list = getList(namespaceList, "ns-0");
		failAdd(list);
		assertEquals("Wrong list.", populate(5, "ns-0"), list);

		list = getList(namespaceList, "ns-4");
		failAdd(list);
		assertEquals("Wrong list.", populate(5, "ns-4"), list);

		list = getList(namespaceList, "ns-3");
		failAdd(list);
		assertEquals("Wrong list.", populate(5, "ns-3"), list);
